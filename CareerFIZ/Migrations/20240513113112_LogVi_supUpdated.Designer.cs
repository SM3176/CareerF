...
namespace CareerFIZ.Migrations
{
    ...
    [Migration("20240513113112_LogVi_supUpdated")]
    partial class LogVi_supUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareerFIZ.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "637c5128-ab7a-460d-92e2-19b6e226ea20",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "789432d8-3e65-4210-acd8-57b6b7bd9ed2",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b0f3a700-d0f2-4109-8719-5e6659866cc5",
            ...
            modelBuilder.Entity("CareerFIZ.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8fb0afd3-95ba-47b8-957f-156a4150a2a0",
                            CreateDate = new DateTime(2024, 5, 13, 14, 31, 12, 136, DateTimeKind.Local).AddTicks(6793),
                            Disable = false,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBy5F/0+Wi4iFH1hgLW/Rq+8opMX1gMJJELlwPcpL2gm9Quef1QBA1yfsQh+8MGL3Q==",
            ...
            modelBuilder.Entity("CareerFIZ.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "the ability to carry out diverse duties in the industry",
                            Name = "Skill",
                            Slug = "skill"
                        },
                        new
            ...
            modelBuilder.Entity("CareerFIZ.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerFIZ.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerFIZ.Models.Time", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerFIZ.Models.Title", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerFIZ.Models.AppUser", b =>
                {
                    ...
                    b.HasOne("CareerFIZ.Models.Country", "Country")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("CareerFIZ.Models.Job", b =>
                {
                    ...
                    b.HasOne("CareerFIZ.Models.Time", "Time")
                        .WithMany("Jobs")
                        .HasForeignKey("TimeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CareerFIZ.Models.Title", "Title")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("JobSkill", b =>
                {
                    b.HasOne("CareerFIZ.Models.Job", null)
                        .WithMany()
                        .HasForeignKey("JobsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CareerFIZ.Models.Skill", null)
                        .WithMany()
